...
public class NewBase64 {
    private Logger logger = Logger.getLogger(NewBase64.class);

    private static final int RANGE = 0xff;
    //自定义码表 可随意变换字母排列顺序，然后会自动生成解密表
    private static char[] Base64ByteToStr = new char[]{
    ...
    public NewBase64(String codeList) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        NewBase64 nb = new NewBase64(token);
